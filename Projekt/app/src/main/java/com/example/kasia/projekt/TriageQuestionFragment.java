...
public class TriageQuestionFragment extends Fragment{ //implements NewActivity.FragmentCommunicator {
   ...
   @Override
    ...
    private void clearAnswer(boolean w2, boolean w3, boolean w4, boolean w5){
        if (w2) {
            radioGroup2.clearCheck();
        }
        if (w3) {
        ...
        radioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.question2rb1) {
                    ...
                    clearAnswer(false, true, true, true);
        ...
        radioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.question3rb1) {
                    ...
                    widokWierszy(true, true, true, false, false, false, false, false);
                    clearAnswer(false, false, true, true);
        ...
        radioGroup4.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.question4rb1) {
                    ...
                    clearAnswer(false, false, false, true);
